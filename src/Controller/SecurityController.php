    ...
    requestBody: new OA\RequestBody(
        content: new OA\JsonContent(
            ...
            properties: [
                ...
                new OA\Property(property: 'password', type: 'string', example: 'votre_mot_de_passe')
            ]
        )
    ),
    responses: [
...
#[OA\Get(
    ...
    responses: [
        new OA\Response(
            ...
            // Optionnel : vous pourriez ajouter un OA\JsonContent ici 
            // si vous vouliez détailler la structure de l'utilisateur renvoyé.
        )
    ]
)]
